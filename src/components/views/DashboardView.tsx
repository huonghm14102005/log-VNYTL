              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-emerald-700 mt-0.5">
                    CCCD: 024090000123 • Bằng lái GPLX Hạng FC • Xe đầu kéo: 15H-056.78 (32 tấn) • Đủ điều kiện nhận chuyến cont & khóa cọc.
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-semibold text-emerald-600 mt-1">
                        Cước: {formatVND(order.freightPrice)} {order.driverName ? `• Tài xế: ${order.driverName} (${order.driverPlateNumber || "15H-056.78"})` : ""}
                      </p>
                    </div>
                  </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-base font-bold text-slate-800">
                {isDriver ? "Thu nhập theo tuần" : "Chi phí vận tải theo tuần"}
              </h3>
              <span className="text-xs font-bold text-emerald-600 flex items-center gap-0.5">
                <ArrowUpRight className="w-3.5 h-3.5" />
                {isDriver ? "+ 8% hiệu suất" : "Tiết kiệm 20% so với xe chiều đi"}
              </span>
            </div>
            ...
            {!isDriver ? (
              <div className="p-3 bg-amber-50 rounded-xl border border-amber-200/80 text-xs text-amber-900 space-y-1">
                <p className="font-bold flex items-center gap-1.5">
                  ...
                  Gợi ý xe đầu kéo & mooc sàn về rỗng chiều Cảng Đình Vũ → Hưng Yên / Bắc Ninh:
                </p>
                <p className="text-[11px] text-amber-800">
                  Có 2 xe đầu kéo container và mooc sàn 32 tấn đang trả hàng tại Đình Vũ/Tân Vũ và tìm cuốc quay đầu giảm 20-25% cước.
                </p>
                <button
