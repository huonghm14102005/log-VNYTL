    ...
    <div className="space-y-6 pb-12 max-w-5xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            <AdminPanelSettingsRoundedIcon className="!w-6 !h-6 text-blue-600" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          ...
          <p className="text-xs text-slate-400 mt-1 flex items-center gap-1">
            <LockRoundedIcon className="!w-4 !h-4 text-amber-500" /> Đóng băng an toàn song phương
          </p>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          ...
          <span className="text-xs font-bold text-emerald-600 flex items-center gap-0.5 mt-1">
            <NorthEastRoundedIcon className="!w-4 !h-4" /> +24% tháng này
          </span>
        </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
        <h3 className="text-sm font-bold text-slate-800 flex items-center gap-2">
          <VerifiedUserRoundedIcon className="!w-5 !h-5 text-blue-600" />
        ...
        <div className="border border-slate-100 rounded-xl p-4 bg-slate-50 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <CheckCircleRoundedIcon className="!w-4 !h-4" /> Duyệt 1 chạm
            </button>
          </div>
        </div>
      </div>
